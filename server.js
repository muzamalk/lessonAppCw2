...
MongoClient.connect(
  ...
  "mongodb+srv://muz123:Test123%21@cluster0.ysjqg.mongodb.net/test?authSource=admin&replicaSet=atlas-cogrce-shard-0&readPreference=primary&appname=MongoDB%20Compass&ssl=true",

  (err, client) => {

    //connecting the client with the database.

    db = client.db("lessonApp"); //This is the name of my Database.
...
app.use(function (req, res, next) {
  ...
  let filePath = path.join(__dirname, "sources/images", req.url);
